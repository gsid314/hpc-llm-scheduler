...
==================================
Power-Only scheduler: always picks the minimum-ΔP feasible placement.
No affinity consideration. No RA agent.
...
PLACER_PROMPT = r"""You are a power-minimizing cluster scheduler. Your ONLY goal is minimum power.
...
GOAL: Minimize incremental cluster power delta_total. Affinity is IGNORED.
...
- Ignore affinity column completely.
...
class HPCSchedulerOrchestrator:
    ...
    def run(self) -> Dict[str, Any]:
        self.log("="*70)
        self.log("HPC Scheduler — POWER ONLY (no affinity, no RA)")
        self.log("="*70)
